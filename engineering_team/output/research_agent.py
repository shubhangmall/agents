...
class ResearchAssistant:
    ...
    def compare_papers(self, topic: str) -> dict:
        ...
        for link, paper in self.papers.items():
            ...
            if (
                topic.lower() in paper["title"].lower()
                or topic.lower() in paper["abstract"].lower()
            ):
    ...
    def calculate_insights(self) -> list:
        ...
        insights = []
        relevant_papers = [
            paper for link, paper in self.papers.items() if self.relevance.get(link) is True
        ]
        ...
        while len(insights) < 3 and self.topics:
            for i, topic in enumerate(self.topics):
                if i < 3 - len(insights):
                    insights.append(
                        f"General insight on {topic}: More research may be needed in this area."
                    )
        ...
        "AI": [
            {
                ...
                "authors": "A. Author",
                "abstract": "An introduction to AI concepts and principles.",
                "link": "link1.com",
            },
            {
                "title": "AI in Practice",
                "authors": "B. Author",
                "abstract": "AI applications in industry and research.",
                "link": "link2.com",
            },
            {
                "title": "Future of AI",
                "authors": "C. Author",
                "abstract": "Predictions for the future development of artificial intelligence.",
                "link": "link3.com",
            },
        ],
        "quantum computing": [
            {
                ...
                "authors": "D. Author",
                "abstract": "Basics of quantum mechanics for computing.",
                "link": "link4.com",
            },
            {
                "title": "Quantum Algorithms",
                "authors": "E. Author",
                "abstract": "Exploring quantum algorithms and their applications.",
                "link": "link5.com",
            },
            {
                "title": "Quantum Supremacy",
                "authors": "F. Author",
                "abstract": "Analysis of quantum supremacy experiments and results.",
                "link": "link6.com",
            },
        ],
        "climate change": [
            {
                ...
                "authors": "G. Author",
                "abstract": "Overview of climate change issues and global impacts.",
                "link": "link7.com",
            },
            {
                "title": "Climate Solutions",
                "authors": "H. Author",
                "abstract": "Technical and policy solutions for climate change mitigation.",
                "link": "link8.com",
            },
            {
                "title": "Climate Models",
                "authors": "I. Author",
                "abstract": "Current climate modeling techniques and predictions.",
                "link": "link9.com",
            },
        ],
    }
